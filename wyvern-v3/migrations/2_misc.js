...
module.exports = async (deployer, network) => {
  ...
  if (network !== 'development') {
    ...
    setConfig('deployed.' + network + '.TestKIP7', TestKIP7.address)
    setConfig('deployed.' + network + '.TestKIP17', TestKIP17.address)
    setConfig('deployed.' + network + '.TestKIP37', TestKIP37.address)
